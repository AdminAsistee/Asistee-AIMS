...
class SupplySingle extends Component {
    constructor() {
        super();
        this.calendarFormat = {
    ...
    render() {
        const id = this.props.match.params.id;
        const supply = get(this.props, 'supplies.details.' + id)
            || find(get(this.props, 'supplies.all'), o => parseInt(o.id, 10) === parseInt(id, 10));
            ...
            <div>
                ...
                <div className="cf w-100 pv3 black-60">
                    <div className="cf w-100 pb3">
                        <h2 className='fl fw2 mv2 black-90 fl w-100 pl2'>Supply Entry # {id}</h2>
                    </div>
                    <div className="fl w-100 w-50-l">
                        <div className="fl w-100 ba b--black-10 bg-white br2 pa2 pa3-l mb3">
                            <div className="fl w-40">
                                <h2 className='fl fw2 mv2 black-90 fl w-100 pl2'>Supply Info</h2>
                            ...
                            <div className="fl w-100 pa2 pt3">
                                <div className={'fl w-100 pv2 b--black-10'}>
                                    ...
                                    <div className={'fl w-70'}>
                                        <span> {moment(get(supply, 'created_at')).utcOffset('+09:00').calendar(null, this.calendarFormat)} </span>
                                    </div>
                                </div>
                                <div className={'fl w-100 pv2 b--black-10'}>
                                    <div className={'fl w-30 pr4'}><span className={'b'}>Updated At</span></div>
                                    <div className={'fl w-70'}>
                                        <span> {moment(get(supply, 'updated_at')).utcOffset('+09:00').calendar(null, this.calendarFormat)} </span>
                                    </div>
                                </div>
                ...
                {get(this.props, 'supplies.loading_single') ?
...
function mapDispatchToProps(dispatch) {
    return {
        getSingleSupply: (id) => {
            // dispatch(SuppliesActions.getSingle(id));
        },
        updateField: (id, payload) => {
            // dispatch(SuppliesActions.updateField(id, payload));
        }
    }
}

// connect and export
export default connect(mapStateToProps, mapDispatchToProps)(SupplySingle);
