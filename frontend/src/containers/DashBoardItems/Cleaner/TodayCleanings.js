...
class TodayCleanings extends Component {
    constructor() {
        super();
        this.calendarFormat = {
    ...
    render() {
        const cleanings = get(this.props, 'dashboard.cleanings', []);
        return (
            <div className="fl w-100 ba b--black-10 bg-white br2 pa2 pa3-l">
                <h2 className='fl fw2 mv2 black-90 fl w-100 pl2'>My Cleanings for Today</h2>
                <div className='fl w5 bb bw1 b--black-10 ml2'/>

                {(get(this.props, 'dashboard.cleanings_loading') && !get(this.props, 'dashboard.cleanings_loaded')) ?
                    ...
                    <FlipMove className="w-100 pt3 dt">
                        <div className="dt-row">
                            ...
                            <div className="fw5 underline dtc ttc ph2 pv3 v-top w-30">Info</div>
                        </div>
                ...
                {/*<pre>*/}
                {/*{JSON.stringify(get(this.props.dashboard, 'cleanings'), null, 4)}*/}
                {/*</pre>*/}
                {/*</div>*/}
            </div>
        );
...
// connect and export
export default connect(mapStateToProps, mapDispatchToProps)(TodayCleanings);
